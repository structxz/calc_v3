...
1. **Склонируйте репозиторий:**
   ...
   cd calc_v3
   ```
2. **Создайте файл `.env` и установите в нем переменные окружения**
...
1. **Соберите контейнеры и запустите их (также необходимо создать .env файл как и при локальном запуске):**
